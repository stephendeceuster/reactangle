...
},{"buffer":"../../../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"../../node_modules/color-name/index.js":[function(require,module,exports) {
'use strict'
...
},{"./conversions":"../../node_modules/color-convert/conversions.js","./route":"../../node_modules/color-convert/route.js"}],"../../node_modules/color-string/color-string.js":[function(require,module,exports) {
/* MIT license */
...
},{"color-name":"../../node_modules/color-name/index.js"}],"../../node_modules/color/index.js":[function(require,module,exports) {
/* MIT license */
...
},{"clone":"../../node_modules/clone/clone.js","color-convert":"../../node_modules/color-convert/index.js","color-string":"../../node_modules/color-string/color-string.js"}],"../../node_modules/random-color/index.js":[function(require,module,exports) {
'use strict';
...
var getRandomRangeIntInc = function getRandomRangeIntInc(min, max) {
...
var Rectangle = /*#__PURE__*/function () {
  function Rectangle(width, height, x, y) {
    ...
    _defineProperty(this, "styling", function () {
      var styles = {
        left: _this._x - _this._width / 2 + "px",
        top: _this._y - _this._height / 2 + "px",
        width: _this._width + "px",
        height: _this._height + "px",
        backgroundColor: (0, _randomColor.default)().hexString()
      };
      Object.assign(_this._ref.style, styles);
    });
  ...
  _createClass(Rectangle, [{
    ...
    key: "changeBgc",
    value: function changeBgc() {
      this._ref.onclick = this.styling;
    }
  }, {
    key: "geefX",
    value: function geefX() {
      return this._x;
    }
  }, {
    key: "width",
    ...
    key: "getDistance",
    value: function getDistance(r1, r2) {
      var dx = r1._x - r2._x;
      var dy = r1._y - r2._y;
    ...
    key: "isColliding",
    value: function isColliding(r1, r2) {
      return !(r1._width / 2 + r2._width / 2 < Math.abs(r1._x - r2._x) && r1._height / 2 + r2._height / 2 < Math.abs(r1._y - r2._y)); // return true if rectangles are colliding
    }
  }]);
...
while (counter--) {
  var w = getRandomRangeIntInc(50, 200);
  var h = getRandomRangeIntInc(50, 250);
  var x = getRandomRangeIntInc(10, 1250);
  var y = getRandomRangeIntInc(10, 620);
  new Rectangle(w, h, x, y);
}

var rect1 = new Rectangle(100, 100, 250, 250);
...
var elements = document.body.querySelectorAll(".rect"); //setInterval(() => {
//  console.log(rect1.geefX());
//}, 500);
},{"random-color":"../../node_modules/random-color/index.js"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
